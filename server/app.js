...
var db = require('./javascripts/services/db');

var configuration = new config.Configuration(CONFIGURATION_FILE);
var sellers = new repositories.Sellers(db);
...
var iterationCounter = new services.IterationCounter(db);
...
configuration.watch();
setTimeout(function () {
  dispatcher.startBuying(iterationCounter);
}, 200)
