...
Dispatcher.prototype = (function () {
    ...
    function scheduleNextIteration(self, iterationCounter, intervalInMillis) {
        setTimeout(function () {
            self.startBuying(iterationCounter);
        }, intervalInMillis);
    }
    ...
    return {
        sendOrderToSellers: function (reduction, currentIteration, badRequest) {
            var self = this,
                order = self.orderService.createOrder(),
                expectedBill = self.orderService.bill(order);
        ...
        startBuying: function (iterationCounter) {
            var iteration = iterationCounter.current();
            ...
            scheduleNextIteration(this, iterationCounter, period.shoppingIntervalInMillis);
        }
    }
})();
